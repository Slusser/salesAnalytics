...
import {
  ...
  CustomerResponseDto,
} from './dto/list-customers-response.dto';
...
export class CustomersController {
    ...
    schema: {
      ...
      properties: {
        ...
        message: {
          type: 'string',
          example:
            'Parametr customerId musi być poprawnym identyfikatorem UUID v4.',
        },
      },
    },
  })
  ...
  @ApiResponse({
    ...
    description:
      'Klient nie został znaleziony lub jest ukryty dla roli viewer.',
    schema: {
      type: 'object',
      properties: {
  ...
  async getById(
    ...
    const result = await this.customersService.getById(
      params.customerId,
      currentUser
    );
    return result;
  ...
  @ApiResponse({
    ...
    schema: {
      ...
      properties: {
        ...
        message: {
          type: 'string',
          example: 'Nie udało się zaktualizować klienta.',
        },
      },
    },
  })
  ...
  @Header('Cache-Control', 'no-store')
  @ApiOperation({
    summary: 'Pobierz listę klientów z paginacją i opcjonalnym filtrem.',
  })
  @ApiQuery({
    name: 'page',
    required: false,
  ...
  @ApiQuery({
    ...
    type: Boolean,
    description:
      'Czy uwzględnić klientów nieaktywnych (wymaga ról editor/owner).',
  })
  @ApiOkResponse({
  ...
  @ApiResponse({
    ...
    schema: {
      ...
      properties: {
        ...
        message: {
          type: 'string',
          example: 'Parametr page musi być większy lub równy 1.',
        },
      },
    },
  })
  @ApiResponse({
    ...
    schema: {
      ...
      properties: {
        ...
        message: {
          type: 'string',
          example: 'Nie udało się pobrać listy klientów.',
        },
      },
    },
  })
  ...
  @ApiResponse({
    ...
    schema: {
      ...
      properties: {
        ...
        message: {
          type: 'string',
          example: 'Brak wymaganych ról do wykonania operacji.',
        },
      },
    },
  })
  ...
  async create(
    ...
    this.logger.debug(
      `Rozpoczynam tworzenie klienta dla aktora ${
        currentUser.actorId
  ...
  private serializeUnknownError(error: unknown): {
    message: string;
    stack?: string;
  } {

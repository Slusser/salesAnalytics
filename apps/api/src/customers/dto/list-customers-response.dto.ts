...
import type { CustomerDto, ListCustomersResponse } from 'apps/shared/dtos/customers.dto'
...
export class CustomerResponseDto implements CustomerDto {
  ...
  @ApiProperty({ description: 'Data soft-delete rekordu.', format: 'date-time', nullable: true })
...
export class ListCustomersResponseDto implements ListCustomersResponse {
  ...
  @ApiProperty({ description: 'Łączna liczba klientów spełniających kryteria.' })
  total!: number

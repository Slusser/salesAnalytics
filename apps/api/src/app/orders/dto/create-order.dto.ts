...
export class CreateOrderDto implements CreateOrderCommand {
  ...
  @ApiProperty({
    description: 'Identyfikator klienta składającego zamówienie',
    format: 'uuid',
  })
  @IsUUID('4', {
    message: 'Pole customerId musi być poprawnym identyfikatorem UUID v4.',
  })
  customerId!: string;
  ...
  @IsDateString(
    {},
    { message: 'Pole orderDate musi być poprawną datą w formacie ISO 8601.' }
  )
  orderDate!: string;

  @ApiProperty({
    description: 'Nazwa pozycji zamówienia',
  ...
  @IsNumber(
    ...
    { message: 'Pole quantity musi być liczbą.' }
  )
  ...
  @IsNumber(
    { allowInfinity: false, allowNaN: false },
    { message: 'Pole producerDiscountPct musi być liczbą.' }
  )
  ...
  @IsNumber(
    { allowInfinity: false, allowNaN: false },
    { message: 'Pole distributorDiscountPct musi być liczbą.' }
  )
  ...
  @ApiProperty({
    description: 'Stawka VAT w procentach',
    minimum: 0,
    maximum: MAX_VAT,
    type: Number,
  })
  ...
  @IsNumber(
    { allowInfinity: false, allowNaN: false },
    { message: 'Pole vatRatePct musi być liczbą.' }
  )
  ...
  @IsNumber(
    { allowInfinity: false, allowNaN: false },
    { message: 'Pole totalNetPln musi być liczbą.' }
  )
  ...
  @IsNumber(
    { allowInfinity: false, allowNaN: false },
    { message: 'Pole totalGrossPln musi być liczbą.' }
  )

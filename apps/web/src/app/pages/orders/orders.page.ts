...
export class OrdersPage {
  ...
  protected readonly showEmpty = computed(() => !this.loading() && !this.error() && this.items().length === 0)
  ...
  protected readonly confirmDialogDescription = this.ordersService.confirmDialogDescription
  protected readonly confirmDialogOrderNo = this.ordersService.confirmDialogOrderNo
  protected readonly confirmDialogLoading = this.ordersService.confirmDialogLoading
  ...
  protected onFiltersChange(partial: Parameters<OrdersListService['setFilterFormState']>[0]): void {
  ...
  protected onSortChange(sort: Parameters<OrdersListService['handleSortChange']>[0]): void {

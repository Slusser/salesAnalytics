...
export class OrdersDataTableComponent {
  ...
  protected onHeaderSort(field: OrdersSortState['field']): void {
    ...
    const direction = this.sort.field === field && this.sort.direction === 'asc' ? 'desc' : 'asc'
  ...
  protected isSorted(field: OrdersSortState['field'], direction: OrdersSortState['direction']): boolean {

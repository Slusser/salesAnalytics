...
@Component({
  ...
  standalone: true,
  imports: [CommonModule, FormsModule, OrdersFilterBarComponent, NzButtonModule, NzSwitchModule, NzIconModule],
...
export class OrdersToolbarComponent {
  ...
  protected readonly includeDeleted = computed(() => Boolean(this.filters.includeDeleted))
  ...
  protected readonly includeDeletedAllowed = computed(() => this.permissions.canIncludeDeleted)

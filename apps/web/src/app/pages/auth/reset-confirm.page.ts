...
export class ResetConfirmPage {
  ...
  protected readonly passwordsMatch = computed(() => this.form.controls.password.value === this.form.controls.confirmPassword.value)
  protected readonly canSubmit = computed(() => this.form.valid && this.passwordsMatch() && !this.loading())
  ...
  protected onSubmit(): void {
    ...
    setTimeout(() => {
      ...
      this.infoMessage.set('Reset haseł poza zakresem MVP. Skontaktuj się z administratorem.')
    }, 600)
  }
}

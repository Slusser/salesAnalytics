...
import type { CustomerFormModel, ServerValidationErrors } from './customer-form.types'
...
export class CustomerFormComponent {
  ...
  private readonly showActiveToggleSignal = signal(this.showActiveToggleState())
  ...
  protected readonly showRestoreButton = computed(() => this.showRestoreSignal())
  protected readonly showSoftDeleteButton = computed(() => this.showSoftDeleteSignal())
  protected readonly showCancelButton = computed(() => this.showCancelSignal())
  protected readonly showActiveToggle = computed(() => this.showActiveToggleSignal())
  protected readonly showCommentField = computed(() => this.showCommentSignal())

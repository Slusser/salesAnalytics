...
export class OrdersListService {
  ...
  private mapRow(dto: OrderListItemDto): OrderRowVm {
    ...
    return {
      ...
      catalogUnitGrossFormatted: this.formatCurrency(dto.catalogUnitGrossPln),
      ...
      distributorPriceFormatted: this.formatCurrency(dto.distributorPricePln),
      customerPricePln: dto.customerPricePln,
      customerPriceFormatted: this.formatCurrency(dto.customerPricePln),
      profitPln: dto.profitPln,
      profitFormatted: this.formatCurrency(dto.profitPln),

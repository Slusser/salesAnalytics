...
import type { CreateOrderCommand, OrderResponse } from 'apps/shared/dtos/orders.dto'
...
export interface OrdersCreateErrorResponse {
  code?: string
  message?: string
  details?: Array<{ field?: keyof CreateOrderCommand; message: string } | string>
}
...
export class OrdersCreateService {
  ...
  private mapError(error: HttpErrorResponse): OrdersCreateError {
    const mapped: OrdersCreateError = new Error('Nie udało się utworzyć zamówienia.')
